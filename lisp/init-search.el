;;; init-search.el --- Search and grep configuration -*- lexical-binding: t; -*-

;;; Commentary:
;; This file configures search tools including consult, color-rg, and ripgrep
;; for efficient text searching across files and directories.
...
;; Color-rg for enhanced grep searching
...
;; Search functions using consult-ripgrep
...
;; Leader key bindings for search commands
(my-leader-def
