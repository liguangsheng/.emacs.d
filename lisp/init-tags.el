(use-package citre
  ...
  (setq
   ...
   citre-readtags-program (or (executable-find "/usr/local/bin/readtags") (executable-find "/usr/bin/readtags"))
   citre-ctags-program (or (executable-find "/usr/local/bin/ctags") (executable-find "/usr/bin/ctags"))
