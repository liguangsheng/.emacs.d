...
(defvar spaceline--colors-alist
  '((gruvbox
    ...
    (leuven
     ((active
       (other     (background . "#5A8ACC") (foreground . "#DCDCCC"))
       (default   (background . "#5A8ACC") (foreground . "#EDEDDD"))
       (highlight (background . "#3560A6") (foreground . "#DCDCCC"))
       (middle    (background . "#4676BB"))
       (inactive
	(default (background . "#373844") (foreground . "#565761"))
	(middle  (background . "#373844"))))
      (highlight . "#ffffff")))
   ))

;; Debug colors
;; (let ((spaceline--colors-alist
;;        '((leuven
;; 	  ((active
;; 	    (other     (background . "#5A8ACC") (foreground . "#DCDCCC"))
;; 	    (default   (background . "#5A8ACC") (foreground . "#EDEDDD"))
